...
<link href="https://fonts.googleapis.com/css2?family=Lexend+Deca:wght@500&display=swap" rel="stylesheet">
    ...
    <body style="background-color: #171a1f; font-family: 'Lexend Deca', sans-serif;">
    <center>
      <br><br><br>
...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@500&display=swap" rel="stylesheet">
    ...
    <body style="background-color: #0f172a; font-family: 'Poppins', sans-serif;">
    <center>
      <br><br><br>
      <h1 style="color: white">Maintenance Mode</h1>
      <p style="color: #BBBBBB">We are working on new features right now. Please wait.</p>
    </center>
    </body>
    `)
        }
        ...
        if ((newsettings.api.client.oauth2.ip["duplicate check"] == true) && ip !== '127.0.0.1') {
          ...
          if (ipuser && ipuser !== userinfo.id) {
            renderFile(
              ...
              null,
              (err, str) => {
                if (err) return res.send('Another account on your IP has been detected, there can only be one account per IP. Think this is a mistake? <a href="https://discord.gg/9jutYRCDQg" target="_blank">Join the Pylex discord and open a ticket.</a>')
                res.status(200);
                res.send(str);
              }
            )
